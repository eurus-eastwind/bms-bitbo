...
export default function BITBoStaffDashboard() {
  return (
    <React.Fragment>
                          ...
                          <div className="col-lg-4">
                              <div className="card widget-flat">
                                  <div className="card-body">
                                      ...
                                      <h5 className="text-muted fw-normal mt-0" title="Number of Customers">Ayuda Distributed</h5>
                          ...
                          <div className="col-lg-4">
                              <div className="card widget-flat">
                                  <div className="card-body">
                                      ...
                                      <h5 className="text-muted fw-normal mt-0" title="Number of Orders">Certificates<br /><br /></h5>
                          ...
                          <div className="col-lg-4">
                              <div className="card widget-flat">
                                  <div className="card-body">
                                      ...
                                      <h5 className="text-muted fw-normal mt-0" title="Number of Orders">Blotter Reports<br /><br /></h5>
                          ...
                          <div className="col-lg-6">
                              <div className="card widget-flat">
                                  <div className="card-body">
                                      ...
                                      <h5 className="text-muted fw-normal mt-0" title="Average Revenue">Population</h5>
                                      <h3 className="mt-3 mb-3">36,254</h3>
                                      <p className="mb-0 text-muted">
                                          <span className="text-success me-2"><i className="mdi mdi-arrow-up-bold" /> 7.00%</span>
                                          <span className="text-nowrap">Since last month</span>
                                      </p>
                                  </div> {/* end card-body*/}
                              </div> {/* end card*/}
                          ...
                          <div className="col-lg-6">
                              <div className="card widget-flat">
                                  <div className="card-body">
                                      ...
                                      <p className="mb-0 text-muted">
                                          <span className="text-success me-2"><i className="mdi mdi-arrow-up-bold" /> 1.87%</span>
                                          <span className="text-nowrap">Since last month</span>
                                      </p>
                                  </div> {/* end card-body*/}
                              </div> {/* end card*/}
                      ...
                      <div className="card">
                          <div className="card-body">
                              ...
                              <div className="dash-item-overlay d-none d-md-block" dir="ltr">
                                  ...
                                  <p className="text-muted font-13 mb-3 mt-2">August 2022 have a lot of fund raising activities made our Brgy. Fund increased.</p>
