...
export default function BITBoBrgyOfficialTopbar() {
  return (
    <React.Fragment>
          <div className="navbar-custom">
              <ul className="list-unstyled topbar-menu float-end mb-0">
                  ...
                  <li className="notification-list">
                      <a className="nav-link" href="../../iHealth/brgy official/index.html">
                          <i className="noti-icon"><button type="button" className="btn btn-info">Switch to
                              <strong>iHealth</strong></button></i>
                      </a>
                  </li>
                  <li className="dropdown notification-list">
                      <a className="nav-link dropdown-toggle nav-user arrow-none me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                          ...
                          <span>
                              ...
                              <span className="account-position">Brgy. Official</span>
                          </span>
                      </a>
                      <div className="dropdown-menu dropdown-menu-end dropdown-menu-animated topbar-dropdown-menu profile-dropdown">
                          ...
                          {/* item*/}
                          <a href="../../login-brgyofficial.html" className="dropdown-item notify-item">
