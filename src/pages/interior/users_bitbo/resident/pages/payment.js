...
export default function BITBoResidentPayment() {
  return (
    <React.Fragment>
                          ...
                          <div className="card-body">
                              <div className="tab-content">
                                  <div className="tab-pane show active" id="buttons-table-pending" data-toggle="lists" data-lists-values="[&quot;js-lists-values-user-name&quot;, &quot;js-lists-values-user-date&quot;, &quot;js-lists-values-user-invoiceid&quot;, &quot;js-lists-values-user-document&quot;]">
                                      <div className="search-form search-form--light col-lg-3"><input type="text" className="form-control search" placeholder="Search Invoice ID., Document Type or Date" />
                                          ...
                                          <tbody className="list" id="staff02">
                                              <tr>
                                                  ...
                                                  <td className="table-action">
                                                      <a href="payment-invoice.html" className="action-icon"> <button type="button" className="btn btn-info"><i className="mdi mdi-eye" />
                                                      </button></a>
                                                  </td>
                                              </tr>
                                              <tr>
