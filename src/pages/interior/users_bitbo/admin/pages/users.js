...
export default function BITBoAdminUsers() {
    return (
        <React.Fragment>
            <div className="container-fluid">
                        ...
                        <div className="card">
                            <div className="card-body">
                                <ul className="nav nav-pills bg-nav-pills mb-3">
                                    ...
                                    <li className="nav-item">
                                        <a href="#buttons-table-admin" data-bs-toggle="tab" aria-expanded="false" className="nav-link">
                                            Admin
                                        </a>
                                    </li>
                                </ul> {/* end nav*/}
                                <div className="tab-content">
                                        ...
                                        <div className="search-form search-form--light col-lg-3"><input type="text" className="form-control search" placeholder="Search User, House No., Purok, Age or Birthday" />
                                            ...
                                            <tbody className="list" id="staff02">
                                                <tr>
                                                    ...
                                                    <td className="table-action">
                                                        <a href="javascript: void(0);" className="action-icon">
                                                            <button type="button" className="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit-purokleader-modal"><i className="mdi mdi-account-edit-outline" />
                                                            </button></a>
                                                    </td>
                                                </tr>
                                                <tr>
                                        ...
                                        <div className="search-form search-form--light col-lg-3"><input type="text" className="form-control search" placeholder="Search User, House No., Purok, Age or Birthday" />
                                            ...
                                            <tbody className="list" id="staff02">
                                                <tr>
                                                    ...
                                                    <td className="table-action">
                                                        <a href="javascript: void(0);" className="action-icon">
                                                            <button type="button" className="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit-healthworker-modal"><i className="mdi mdi-account-edit-outline" />
                                                            </button></a>
                                                    </td>
                                                </tr>
                                                <tr>
                                        ...
                                        <div className="search-form search-form--light col-lg-3"><input type="text" className="form-control search" placeholder="Search User, House No., Purok, Age or Birthday" />
                                            ...
                                            <tbody className="list" id="staff02">
                                                <tr>
                                                    ...
                                                    <td className="table-action">
                                                        <a href="javascript: void(0);" className="action-icon">
                                                            <button type="button" className="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit-staff-modal"><i className="mdi mdi-account-edit-outline" />
                                                            </button></a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <div className="search-form search-form--light col-lg-3"><input type="text" className="form-control search" placeholder="Search User, House No., Purok, Age" />
                                                    ...
                                                    <tbody className="list" id="staff02">
                                                        <tr>
                                                            ...
                                                            <td className="table-action">
                                                                <a href="javascript: void(0);" className="action-icon">
                                                                    <button type="button" className="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit-official-modal"><i className="mdi mdi-account-edit-outline" />
                                                                    </button></a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                    ...
                                    <div className="tab-pane" id="buttons-table-admin" data-toggle="lists" data-lists-values="[&quot;js-lists-values-user-name&quot;, &quot;js-lists-values-user-housestreet&quot;, &quot;js-lists-values-user-purok&quot;, &quot;js-lists-values-user-age&quot;, &quot;js-lists-values-user-bday&quot;]">
                                        <div className="search-form search-form--light col-lg-3"><input type="text" className="form-control search" placeholder="Search User, House No., Purok, Age or Birthday" />
                                        </div><table id="table table-centered" className="table-responsive mb-0">
                                        </table><table id className="table dt-responsive nowrap w-100">
                                            <thead>
                                            ...
                                            <tbody className="list" id="staff02">
                                                <tr>
                                                    ...
                                                    <td><span className="js-lists-values-user-bday">1998/07/29</span>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <input type="checkbox" id="switch16" defaultChecked data-switch="success" />
                                                            <label htmlFor="switch16" data-on-label="Yes" data-off-label="No" className="mb-0 d-block" />
                                                        </div>
                                                    </td>
                                                    <td className="table-action">
                                                        <a href="javascript: void(0);" className="action-icon">
                                                            <button type="button" className="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit-admin-modal"><i className="mdi mdi-account-edit-outline" />
                                                            </button></a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><span className="js-lists-values-user-bday">1998/07/30</span>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <input type="checkbox" id="switch17" defaultChecked data-switch="success" />
                                                            <label htmlFor="switch17" data-on-label="Yes" data-off-label="No" className="mb-0 d-block" />
                                                        </div>
                                                    </td>
                                                    <td className="table-action">
                                                        <a href="javascript: void(0);" className="action-icon">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span className="js-lists-values-user-bday">1998/07/31</span>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <input type="checkbox" id="switch18" defaultChecked data-switch="success" />
                                                            <label htmlFor="switch18" data-on-label="Yes" data-off-label="No" className="mb-0 d-block" />
                                                        </div>
                                                    </td>
                                                    <td className="table-action">
                                                        <a href="javascript: void(0);" className="action-icon">
                ...
                {/* Edit Admin Modal */}
                <div id="edit-admin-modal" className="modal fade" tabIndex={-1} role="dialog" aria-labelledby="warning-header-modalLabel" aria-hidden="true">
                    <div className="modal-dialog modal-lg">
                        <div className="modal-content">
                            <div className="modal-header modal-colored-header bg-primary">
                                <h4 className="modal-title" id="warning-header-modalLabel">Edit Admin Details</h4>
                            </div>
                            <div className="modal-body">
                                <form>
                                    <div className="row">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-4">
                                            <div className="mb-3">
                                                <label htmlFor="lastname" className="form-label">Username</label>
                                                <input type="text" className="form-control" id="admin_username" placeholder="Enter username" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="row">
                                        <div className="col-md-6">
                                            <div className="mb-3">
                                                <label htmlFor="useremail" className="form-label">Email Address</label>
                                                <input type="email" className="form-control" id="admin_email" placeholder="Enter email" />
                                            </div>
                                        </div>
                                        <div className="col-md-6">
                                            <div className="mb-3">
                                                <label htmlFor="userpassword" className="form-label">Password</label>
                                                <input type="password" className="form-control" id="admin_userpassword" placeholder="Enter password" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="row">
                                        <div className="col-md-12">
                                            <div className="mb-3">
                                                <label htmlFor="useremail" className="form-label">Profile Picture</label>
                                                <input type="file" className="form-control" id="admin_profile_pic" placeholder="Upload Photo" />
                                            </div>
                                        </div>
                                    </div>
                                </form>
                            ...
                            <div className="modal-footer">
                                <button type="button" className="btn btn-light" data-bs-dismiss="modal">Close</button>
                                <button type="button" className="btn btn-primary" data-bs-dismiss="modal" id="toastr-updateadmin">Save
                                    changes</button>
                            </div>
                        </div>{/* /.modal-content */}
                    </div>{/* /.modal-dialog */}
                ...
                {/* Official Edit Modal */}
                <div id="edit-official-modal" className="modal fade" tabIndex={-1} role="dialog" aria-labelledby="warning-header-modalLabel" aria-hidden="true">
                    <div className="modal-dialog modal-lg">
                        <div className="modal-content">
                            <div className="modal-header modal-colored-header bg-primary">
                                <h4 className="modal-title" id="warning-header-modalLabel">Edit Brgy. Official Details
                                </h4>
                            </div>
                            <div className="modal-body">
                                <form>
                            ...
                            <div className="modal-footer">
                                <button type="button" className="btn btn-light" data-bs-dismiss="modal">Close</button>
                                <button type="button" className="btn btn-primary" data-bs-dismiss="modal" id="toastr-five2">Save
                                    changes</button>
                            </div>
                        </div>{/* /.modal-content */}
                    </div>{/* /.modal-dialog */}
                ...
                {/* Staff Edit Modal */}
                <div id="edit-staff-modal" className="modal fade" tabIndex={-1} role="dialog" aria-labelledby="warning-header-modalLabel" aria-hidden="true">
                    <div className="modal-dialog modal-lg">
                        <div className="modal-content">
                            <div className="modal-header modal-colored-header bg-primary">
                                <h4 className="modal-title" id="warning-header-modalLabel">Edit Staff Details</h4>
                            </div>
                            <div className="modal-body">
                                <form>
                                    <div className="row">
                            ...
                            <div className="modal-footer">
                                <button type="button" className="btn btn-light" data-bs-dismiss="modal">Close</button>
                                <button type="button" className="btn btn-primary" data-bs-dismiss="modal" id="toastr-staffupdate">Save
                                    changes</button>
                            </div>
                        </div>{/* /.modal-content */}
                    </div>{/* /.modal-dialog */}
                ...
                <div id="edit-healthworker-modal" className="modal fade" tabIndex={-1} role="dialog" aria-labelledby="warning-header-modalLabel" aria-hidden="true">
                    <div className="modal-dialog modal-lg">
                        <div className="modal-content">
                            <div className="modal-header modal-colored-header bg-primary">
                                <h4 className="modal-title" id="warning-header-modalLabel">Edit Health Worker Details
                                </h4>
                            </div>
                            <div className="modal-body">
                                <form>
                            ...
                            <div className="modal-footer">
                                <button type="button" className="btn btn-light" data-bs-dismiss="modal">Close</button>
                                <button type="button" className="btn btn-primary" data-bs-dismiss="modal" id="toastr-hworkerupdate">Save
                                    changes</button>
                            </div>
                        </div>{/* /.modal-content */}
                    </div>{/* /.modal-dialog */}
                ...
                {/* Health Worker Edit Modal */}
                <div id="edit-purokleader-modal" className="modal fade" tabIndex={-1} role="dialog" aria-labelledby="warning-header-modalLabel" aria-hidden="true">
                    <div className="modal-dialog modal-lg">
                        <div className="modal-content">
                            <div className="modal-header modal-colored-header bg-primary">
                                <h4 className="modal-title" id="warning-header-modalLabel">Edit Purok Leader Details
                                </h4>
                            </div>
                            <div className="modal-body">
                                <form>
                            ...
                            <div className="modal-footer">
                                <button type="button" className="btn btn-light" data-bs-dismiss="modal">Close</button>
                                <button type="button" className="btn btn-primary" data-bs-dismiss="modal" id="toastr-pleaderupdate">Save
                                    changes</button>
                            </div>
                        </div>{/* /.modal-content */}
                    </div>{/* /.modal-dialog */}
