...
export default function IHealthResidentTopbar() {
  return (
    <React.Fragment>
          <div className="navbar-custom">
              <ul className="list-unstyled topbar-menu float-end mb-0">
                  ...
                  <li className="notification-list">
                      <a className="nav-link" href="../../BITBo/resident/index.html">
                          <i className="noti-icon"><button type="button" className="btn btn-primary">
                  ...
                  <li className="dropdown notification-list">
                      ...
                      <div className="dropdown-menu dropdown-menu-end dropdown-menu-animated topbar-dropdown-menu profile-dropdown">
                          ...
                          {/* item*/}
                          <a href="/BITBo/login-resident.html" className="dropdown-item notify-item">
