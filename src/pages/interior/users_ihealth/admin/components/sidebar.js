...
export default function IHealthAdminSidebar() {
    return (
        <React.Fragment>
            <div className="leftside-menu">
                ...
                {/* LOGO */}
                <a href="admin-index.html" className="logo text-center logo-light">
                ...
                <div className="h-100" id="leftside-menu-container" data-simplebar>
                    ...
                    <ul className="side-nav">
                        ...
                        <li className="side-nav-item">
                            <a data-bs-toggle="collapse" href="#generalserv" aria-expanded="false" aria-controls="generalserv" className="side-nav-link">
