...
export default function IHealthBrgyOfficialDentalServices() {
  return (
    <React.Fragment>
              ...
              <div className="row">
                  <div className="col-12">
                      <div className="page-title-box">
                          <h4 className="page-title">Dental Check-Up Appointment</h4>
                      </div>
                  </div>
              </div>
              {/* end page title */}
                                      ...
                                      <div className="search-form search-form--light col-lg-3"><input type="text" className="form-control search" placeholder="Search Appointment ID, Name or Date" />
                                          ...
                                          <tbody className="list" id="staff02">
                                              <tr>
                                                  <td>
                                                      <div className="media align-items-center">
                                                          <div className="media-body d-flex flex-column"><strong className="js-lists-values-appointmentid">DC-2022-0001</strong>
                                                          </div>
                                                      </div>
                                                  </td>
                                                  <td>
                                                  ...
                                                  <td>
                                                      <span className="js-lists-values-service">Dental
                                                          Check-Up</span>
                                                  </td>
                                              ...
                                              <tr>
                                                  <td>
                                                      <div className="media align-items-center">
                                                          <div className="media-body d-flex flex-column"><strong className="js-lists-values-appointmentid">DC-2022-0003</strong>
                                                          </div>
                                                      </div>
                                                  </td>
                                                  <td>
                                      ...
                                      <div className="search-form search-form--light col-lg-3"><input type="text" className="form-control search" placeholder="Search Appointment ID, Name or Date" />
                                          ...
                                          <tbody className="list" id="staff02">
                                              <tr>
                                                  <td>
                                                      <div className="media align-items-center">
                                                          <div className="media-body d-flex flex-column"><strong className="js-lists-values-appointmentid">DC-2022-0004</strong>
                                                          </div>
                                                      </div>
                                                  </td>
                                                  <td>
                                              ...
                                              <tr>
                                                  <td>
                                                      <div className="media align-items-center">
                                                          <div className="media-body d-flex flex-column"><strong className="js-lists-values-appointmentid">DC-2022-0005</strong>
                                                          </div>
                                                      </div>
                                                  </td>
                                                  <td>
                                              ...
                                              <tr>
                                                  <td>
                                                      <div className="media align-items-center">
                                                          <div className="media-body d-flex flex-column"><strong className="js-lists-values-appointmentid">DC-2022-0006</strong>
                                                          </div>
                                                      </div>
                                                  </td>
                                                  <td>
                                      ...
                                      <div className="search-form search-form--light col-lg-3"><input type="text" className="form-control search" placeholder="Search Appointment ID, Name or Date" />
                                          ...
                                          <tbody className="list" id="staff02">
                                              <tr>
                                                  <td>
                                                      <div className="media align-items-center">
                                                          <div className="media-body d-flex flex-column"><strong className="js-lists-values-appointmentid">DC-2022-0007</strong>
                                                          </div>
                                                      </div>
                                                  </td>
                                                  <td>
                                              ...
                                              <tr>
                                                  <td>
                                                      <div className="media align-items-center">
                                                          <div className="media-body d-flex flex-column"><strong className="js-lists-values-appointmentid">DC-2022-0008</strong>
                                                          </div>
                                                      </div>
                                                  </td>
                                                  <td>
                                              ...
                                              <tr>
                                                  <td>
                                                      <div className="media align-items-center">
                                                          <div className="media-body d-flex flex-column"><strong className="js-lists-values-appointmentid">DC-2022-0009</strong>
                                                          </div>
                                                      </div>
                                                  </td>
                                                  <td>
                                      ...
                                      <div className="search-form search-form--light col-lg-3"><input type="text" className="form-control search" placeholder="Search Appointment ID, Name or Date" />
                                          ...
                                          <tbody className="list" id="staff02">
                                              <tr>
                                                  <td>
                                                      <div className="media align-items-center">
                                                          <div className="media-body d-flex flex-column"><strong className="js-lists-values-appointmentid">DC-2022-0010</strong>
                                                          </div>
                                                      </div>
                                                  </td>
                                                  <td>
                                              ...
                                              <tr>
                                                  <td>
                                                      <div className="media align-items-center">
                                                          <div className="media-body d-flex flex-column"><strong className="js-lists-values-appointmentid">DC-2022-0011</strong>
                                                          </div>
                                                      </div>
                                                  </td>
                                                  <td>
                                              ...
                                              <tr>
                                                  <td>
                                                      <div className="media align-items-center">
                                                          <div className="media-body d-flex flex-column"><strong className="js-lists-values-appointmentid">DC-2022-0012</strong>
                                                          </div>
                                                      </div>
                                                  </td>
                                                  <td>
                  ...
                  <div className="modal-dialog">
                      <div className="modal-content">
                          <div className="modal-header modal-colored-header bg-primary">
                              <h4 className="modal-title" id="info-header-modalLabel">Dental Appointment Details</h4>
                                  ...
                                  <div className="row">
                                      <div className="col-md-12">
                                          <div className="mb-3">
                                              ...
                                              <input type="text" className="form-control" id="firstname" placeholder="Resident Name" defaultValue="DC-2022-0001" disabled />
                                          </div>
                                      </div>
                                  </div>
                                  <div className="row">
              ...
              <div id="view-request-modal" className="modal fade" tabIndex={-1} role="dialog" aria-labelledby="info-header-modalLabel" aria-hidden="true">
                  <div className="modal-dialog">
                      <div className="modal-content">
                          ...
                          <div className="modal-body">
                              <form>
                                  <p><strong>Appointment ID.: </strong>DC-2022-0001</p>
                                  ...
                                  <p><strong>Service: </strong>Dental Check-Up</p>
