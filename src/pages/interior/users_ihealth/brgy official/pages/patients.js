...
export default function IHealthBrgyOfficialPatients() {
    return (
        <React.Fragment>
            <div className="container-fluid">
                            ...
                            <div className="card-body">
                                <ul className="nav nav-pills mb-3">
                                    <li className="nav-item">
                                        <a href="#buttons-table-patients" data-bs-toggle="tab" aria-expanded="true" className="nav-link active">
                                            Patients
                                        </a>
                                    </li>
                                    <li className="nav-item">
                                        <a href="#buttons-table-seniors" data-bs-toggle="tab" aria-expanded="true" className="nav-link">
                                            Senior Citizens
                                        </a>
                                    </li>
                                </ul> {/* end nav*/}
                                <div className="tab-content">
                                    <div className="tab-pane show active" id="buttons-table-patients" data-toggle="lists" data-lists-values="[&quot;js-lists-values-user-name&quot;, &quot;js-lists-values-user-housestreet&quot;, &quot;js-lists-values-user-purok&quot;, &quot;js-lists-values-user-age&quot;, &quot;js-lists-values-user-bday&quot;]">
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="table-action">
                                                        <a href="javascript: void(0);" className="action-icon">
                                                            <button type="button" className="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit-patient-modal"><i className="mdi mdi-account-edit-outline" />
                                                            </button></a>
                                                    </td>
                                                </tr>
                                                <tr>
                                    ...
                                    <div className="tab-pane" id="buttons-table-seniors" data-toggle="lists" data-lists-values="[&quot;js-lists-values-user-name&quot;, &quot;js-lists-values-user-housestreet&quot;, &quot;js-lists-values-user-purok&quot;, &quot;js-lists-values-user-age&quot;, &quot;js-lists-values-user-bday&quot;]">
                                        <div className="search-form search-form--light col-lg-3"><input type="text" className="form-control search" placeholder="Search User, House No., Purok, Age or Birthday" />
                                        </div><table id="table table-centered" className="table-responsive mb-0">
                                        </table><table id className="table dt-responsive nowrap w-100">
                                            <thead>
                                            ...
                                            <tbody className="list" id="staff02">
                                                <tr>
                                                    ...
                                                    <td><span className="js-lists-values-user-age">60</span>
                                                    </td>
                                                    ...
                                                    <td className="table-action">
                                                        <a href="javascript: void(0);" className="action-icon">
                                                            <button type="button" className="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit-senior-modal"><i className="mdi mdi-account-edit-outline" />
                                                            </button></a>
                                                    </td>
                                                </tr>
                                                <tr>
                ...
                {/*MODALS*/}
                {/* Edit Patient Modal */}
                <div id="edit-patient-modal" className="modal fade" tabIndex={-1} role="dialog" aria-labelledby="warning-header-modalLabel" aria-hidden="true">
                    <div className="modal-dialog modal-lg">
                        <div className="modal-content">
                            <div className="modal-header modal-colored-header bg-primary">
                                <h4 className="modal-title" id="warning-header-modalLabel">Edit Patient Details</h4>
                            </div>
                            ...
                            <div className="modal-footer">
                                ...
                                <button type="button" className="btn btn-primary" data-bs-dismiss="modal" id="toastr-updatepatient">Save
                                    changes</button>
                            </div>
                        </div>{/* /.modal-content */}
                    </div>{/* /.modal-dialog */}
                ...
                {/* Edit Senior Modal */}
                <div id="edit-senior-modal" className="modal fade" tabIndex={-1} role="dialog" aria-labelledby="warning-header-modalLabel" aria-hidden="true">
                    <div className="modal-dialog modal-lg">
                        <div className="modal-content">
                            <div className="modal-header modal-colored-header bg-primary">
                                <h4 className="modal-title" id="warning-header-modalLabel">Edit Senior Citizen Details</h4>
                            </div>
                            <div className="modal-body">
                                <form>
                                    <div className="row">
                            ...
                            <div className="modal-footer">
                                <button type="button" className="btn btn-light" data-bs-dismiss="modal">Close</button>
                                <button type="button" className="btn btn-primary" data-bs-dismiss="modal" id="toastr-updatesenior">Save
                                    changes</button>
                            </div>
                        </div>{/* /.modal-content */}
                    </div>{/* /.modal-dialog */}
