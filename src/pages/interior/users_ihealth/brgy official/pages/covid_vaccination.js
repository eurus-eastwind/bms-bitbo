...
export default function IHealthBrgyOfficialCovidVaccination() {
  return (
    <React.Fragment>
              ...
              <div className="row">
                  <div className="col-12">
                      <div className="page-title-box">
                          <h4 className="page-title">COVID-19 Vaccination Appointment</h4>
                      </div>
                  </div>
              </div>
              {/* end page title */}
                      ...
                      <div className="card">
                          <div className="card-body">
                              ...
                              <div className="tab-content">
                                      ...
                                      <div className="search-form search-form--light col-lg-3"><input type="text" className="form-control search" placeholder="Search Appointment ID, Name or Date" />
                                          ...
                                          <tbody className="list" id="staff02">
                                              <tr>
                                                  ...
                                                  <td>
                                                      <span className="js-lists-values-service">COVID-19 Vaccine</span>
                                                  </td>
                                      ...
                                      <div className="search-form search-form--light col-lg-3"><input type="text" className="form-control search" placeholder="Search Appointment ID, Name or Date" />
                                          ...
                                          <tbody className="list" id="staff02">
                                              <tr>
                                                  <td>
                                                      <div className="media align-items-center">
                                                          <div className="media-body d-flex flex-column"><strong className="js-lists-values-appointmentid">VA-2022-0004</strong>
                                                          </div>
                                                      </div>
                                                  </td>
                                                  <td>
                                              ...
                                              <tr>
                                                  <td>
                                                      <div className="media align-items-center">
                                                          <div className="media-body d-flex flex-column"><strong className="js-lists-values-appointmentid">VA-2022-0005</strong>
                                                          </div>
                                                      </div>
                                                  </td>
                                                  <td>
                                              ...
                                              <tr>
                                                  <td>
                                                      <div className="media align-items-center">
                                                          <div className="media-body d-flex flex-column"><strong className="js-lists-values-appointmentid">VA-2022-0006</strong>
                                                          </div>
                                                      </div>
                                                  </td>
                                                  <td>
                                  ...
                                  <div className="tab-pane" id="buttons-table-declined" data-toggle="lists" data-lists-values="[&quot;js-lists-values-appointmentid&quot;, &quot;js-lists-values-name&quot;, &quot;js-lists-values-date&quot;, &quot;js-lists-values-time&quot;, &quot;js-lists-values-service&quot;, &quot;js-lists-values-dosestatus&quot;]">
                                      <div className="search-form search-form--light col-lg-3"><input type="text" className="form-control search" placeholder="Search Appointment ID, Name or Date" />
                                      </div><table id="table table-centered" className="table-responsive mb-0">
                                      </table><table id className="table dt-responsive nowrap w-100">
                                          <thead>
                                          ...
                                          <tbody className="list" id="staff02">
                                              ...
                                              <tr>
                                                  <td>
                                                      <div className="media align-items-center">
                                                          <div className="media-body d-flex flex-column"><strong className="js-lists-values-appointmentid">VA-2022-0008</strong>
                                                          </div>
                                                      </div>
                                                  </td>
                                                  <td>
                                              ...
                                              <tr>
                                                  <td>
                                                      <div className="media align-items-center">
                                                          <div className="media-body d-flex flex-column"><strong className="js-lists-values-appointmentid">VA-2022-0009</strong>
                                                          </div>
                                                      </div>
                                                  </td>
                                                  <td>
                                  ...
                                  <div className="tab-pane" id="buttons-table-history" data-toggle="lists" data-lists-values="[&quot;js-lists-values-appointmentid&quot;, &quot;js-lists-values-name&quot;, &quot;js-lists-values-date&quot;, &quot;js-lists-values-time&quot;, &quot;js-lists-values-service&quot;, &quot;js-lists-values-dosestatus&quot;]">
                                      <div className="search-form search-form--light col-lg-3"><input type="text" className="form-control search" placeholder="Search Appointment ID, Name or Date" />
                                      </div><table id="table table-centered" className="table-responsive mb-0">
                                      </table><table id className="table dt-responsive nowrap w-100">
                                          <thead>
                                          ...
                                          <tbody className="list" id="staff02">
                                              <tr>
                                                  <td>
                                                      <div className="media align-items-center">
                                                          <div className="media-body d-flex flex-column"><strong className="js-lists-values-appointmentid">VA-2022-0010</strong>
                                                          </div>
                                                      </div>
                                                  </td>
                                                  <td>
                                              ...
                                              <tr>
                                                  <td>
                                                      <div className="media align-items-center">
                                                          <div className="media-body d-flex flex-column"><strong className="js-lists-values-appointmentid">VA-2022-0011</strong>
                                                          </div>
                                                      </div>
                                                  </td>
                                                  <td>
                                              ...
                                              <tr>
                                                  <td>
                                                      <div className="media align-items-center">
                                                          <div className="media-body d-flex flex-column"><strong className="js-lists-values-appointmentid">VA-2022-0012</strong>
                                                          </div>
                                                      </div>
                                                  </td>
                                                  <td>
                  ...
                  <div className="modal-dialog">
                      <div className="modal-content">
                          <div className="modal-header modal-colored-header bg-primary">
                              <h4 className="modal-title" id="info-header-modalLabel">Vaccination Appointment Details</h4>
                          ...
                          <div className="modal-body">
                              <form>
                                  ...
                                  <div className="row">
                                      <div className="col-md-6">
                                          <div className="mb-3">
                                              <label htmlFor="lastname" className="form-label">Vaccine Manufacturer</label>
                                              <select className="form-select" id="example-select">
